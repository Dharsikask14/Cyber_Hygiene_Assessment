      ...
      <Page style={{ paddingTop: queryId ? 36 : 36 }}>
        ...
        <div className="card" style={{ marginBottom: 20 }}>
          ...
          <a
            ...
            style={{ width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, background: '#0A66C2', color: '#fff', borderRadius: 10, padding: 12, fontSize: 14, fontWeight: 600, textDecoration: 'none', transition: 'opacity 0.2s', marginBottom: 20 }}
