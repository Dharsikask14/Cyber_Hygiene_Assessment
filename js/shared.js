...
window.getGrade = function(p) {
  ...
  if (p >= 65) return { grade: "B", label: "Average", color: "var(--grade-b)", bg: "var(--grade-b-bg)", desc: "Moderate risk. You are vulnerable to common cyber attacks." };
  if (p >= 50) return { grade: "C+", label: "Below Average", color: "var(--grade-cp)", bg: "var(--grade-cp-bg)", desc: "Several bad habits. You are an easy target for scammers and hackers." };
